...
def search_for_case():
    ...
    with open("districtcourturl.txt", "r") as fp:
        ...
        for courtlink in courtlinks:
            ...
            driver.find_element(by=By.XPATH, value='//input[contains(@name, "searchTerm")]').send_keys("01/01/2020")
            ...
            while(next_btn_available):
                try:
                   raw_clinks= driver.find_element(by=By.XPATH , value="//td[contains(@class, 'errorFont')]")
                   print("No Case Number available on this date")
